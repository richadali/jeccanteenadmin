...
snapshot.docChanges().forEach((change) => {
  ...
  getDownloadURL(image).then((url) => {
    ...
    imageurl = url; 
      ...
      cell5.innerHTML = '<button class="w3-round-small w3-btn w3-purple w3-medium" data-toggle="modal" data-target="#exampleModalCenter" onclick="FillTboxes()"><i class="fa fa-pencil-square-o"></i> / <i class="fa fa-trash"></i></button>';
    i+=1;
